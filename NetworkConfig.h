...
YOJIMBO_DECLARE_MESSAGE_TYPE(WEB_WALL_BREAK, WebWallBreakMessage);
...
YOJIMBO_DECLARE_MESSAGE_TYPE(CHEST_OPEN, ChestOpenMessage);
YOJIMBO_DECLARE_MESSAGE_TYPE(PICKUP_COLLECT, PickupCollectMessage);
YOJIMBO_DECLARE_MESSAGE_TYPE(TRIGGER_ONPRESSB, TriggerOnPressBMessage);
YOJIMBO_DECLARE_MESSAGE_TYPE(TRIGGER_ONUSE, TriggerOnUseMessage);
YOJIMBO_DECLARE_MESSAGE_TYPE(SWITCH_TOGGLE, SwitchToggleMessage);
YOJIMBO_DECLARE_MESSAGE_TYPE(ANIM_SYNC, AnimSyncMessage);
YOJIMBO_DECLARE_MESSAGE_TYPE(RING_SYNC, RingSyncMessage);
